...
def main(_):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        jpeg_data_tensor, decoded_image_tensor = utils.decode_jpeg(
            ...
            model_config["input_depth"],
            model_config["input_mean"],
        ...
        for i in range(FLAGS.training_steps):
            ...
            if (i % FLAGS.eval_frequency) == 0 or final_step:
                ...
                if validation_accuracy > best_acc:
                    ...
                    utils.save_graph_to_file(
                        sess, graph, FLAGS.output_graph, FLAGS.final_tensor_name
                    )

                validation_writer.add_summary(validation_summary, i)

                tf.logging.info(
                    "Step {}: loss = {} train acc = {} val acc = {}".format(
    ...
    print(
        "Total Model Runtime: {}min, {:0.2f}sec".format(
